...
# path to mkdep (including separator - implement for windows later)
i_separator = sys.argv[0].rfind("/")
MKDEPPATH = sys.argv[0][:i_separator+1]
...
## override default values with environment variables. PS Makefile variables does not count.
# tmpstring = os.environ.get('CPP_FLAGS')
